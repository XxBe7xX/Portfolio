        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Bahaa EL-Din</a></h1>
              <span className="email"><i className="icon-mail"></i> bahaa11osama@yahoo.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                <li><a href="https://www.facebook.com/bahaaeldin.mohamed.79/" target="_blank" rel="noopener noreferrer"><i className="icon-facebook2" /></a></li>
                ...
                <li><a href="https://github.com/xxbe7xx" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
            ...
            <div className="colorlib-footer">
              ...
              <p><small>
                  Made with <i className="icon-heart" aria-hidden="true" /> & <i className="icon-coffee" aria-hidden="true"></i><br></br>
